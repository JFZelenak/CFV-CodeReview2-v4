...
let bookmarkedClass = "bi-bookmark";
            ...
            <div>
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex justify-content-end">
                        <i class="bi ${isBookmarked(i)} myBookmarkBtn"></i>
...
function isBookmarked(i) {
    if (obj1[i].isBookmarked === "bi-bookmark-fill") {
        bookmarkedArray[i] = "bi-bookmark-fill";
        bookmarkedClass = "bi-bookmark-fill myScaledY";
    } else {
        bookmarkedArray[i] = "bi-bookmark";
        bookmarkedClass = "bi-bookmark";
    }
...
sortBtn.addEventListener("click", function(){
    ...
    // remove the old arrays from storage
